...
### 1. 여러 노드에 데이터가 흩어지면 정합성 유지가 어려워진다
...
### 2. 복잡한 동기화 메커니즘 대신 라우팅 정책으로 문제를 해결했다
